      ...
      child: VStack([
        ...
        HStack([
          ...
          Visibility(
            ...
            child: HStack([
              Icon(FlutterIcons.x_fea, color: Colors.red, size: 20).onInkTap(
                newTaxiOrderLocationEntryViewModel.clearScheduleSelection,
              ),
              UiSpacer.hSpace(10),
            ]),
          ),
          ...
          HStack(
                [
                  Icon(FlutterIcons.calendar_ant, size: 18),
                  UiSpacer.hSpace(5),
