...
class MyBaseViewModel extends BaseViewModel
  ...
  shareProduct(Product product) async {
    ...
    String shareLink = "${Api.appShareLink}/product/${product.id}";
  ...
  shareVendor(Vendor vendor) async {
    ...
    String shareLink = "${Api.appShareLink}/vendor/${vendor.id}";
    await Share.share(shareLink);
  ...
  shareService(Service service) async {
    ...
    String shareLink = "${Api.appShareLink}/service/${service.id}";
    await Share.share(shareLink);
