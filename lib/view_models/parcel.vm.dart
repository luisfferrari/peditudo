...
class ParcelViewModel extends MyBaseViewModel {
  //
  ParcelViewModel(BuildContext context, {required this.vendorType}) {
  ...
  trackOrder(String orderCode) async {
    ...
    try {
      ...
      setError(error);
      //
      AlertService.error(title: "Track your package".tr(), text: "$error");
    }
    ...
    final result = await showDialog(
      ...
      builder: (context) {
        return Dialog(
          child: VStack([
            //qr code preview
            QRView(key: qrKey, onQRViewCreated: _onQRViewCreated).h48(context),
            //
            HStack([
